...
```{r}
raw <- read.table("merged_metaphlan.txt")
data <- read.table("new_mat_prop.txt")
meta <- read.table("DMOF6_merged_metadata_ag copy.txt",
                              header = TRUE,
                              sep = "\t",
                              fill = TRUE,
                              quote = "",
...
write.csv(
  combined_diet,
  file = "~/Desktop/microbiome/combined_diet.csv"
)
...
```{r}
combined_diet <- read.csv("combined_diet.csv",
                          header    = TRUE,  
                          row.names = 1,  
...
write.csv(lmm_results,
           "~/Desktop/microbiome/lmm_taxa.csv",
           row.names = FALSE)
...
write.csv(combined_clr,
          "~/Desktop/microbiome/combined_clr.csv",
          row.names = TRUE)
...
write.csv(lasso_tbl,
          "~/Desktop/microbiome/lasso_selected_taxa.csv",
          row.names = FALSE)
